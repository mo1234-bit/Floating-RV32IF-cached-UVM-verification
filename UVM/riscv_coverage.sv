...
class riscv_coverage extends uvm_subscriber #(reg_write_txn);
    ...
    covergroup cg_hazards;
        ...
        ignore_bins impossible_stall_f_without_d =
            binsof(cp_stall_f.stalled) && binsof(cp_stall_d.free);
        ignore_bins impossible_stall_d_without_f =
            binsof(cp_stall_f.free) && binsof(cp_stall_d.stalled);}
    endgroup
